...
export default function Googlesignup() {
  return (
    <>
        <div className='word gap-4 bg-[#E4E7EB] h-10.5 rounded-sm font-semibold flex text-center items-center justify-center'>
          <svg  xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 128 128">
            ...
            <p className='word  text-[#4B5768] font-normal text-[16px] '> Continue with Google</p>
        </div>
    </>
  )
}
